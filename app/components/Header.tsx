...
const Header = () => {
  return (
    <div className="">
      ...
      <h1
        className="font-bold font-serif text-right bg-gradient-to-r from-red-400 hover:from-pink-500 hover:to-orange-500 pb-2 pr-4 pt-2 sm:text-3xl md:text-4xl lg:text-5xl italic hover:not-italic mb-5 ml-5 "
        data-aos="fade-right"
        data-aos-easing="ease-in"
      >
